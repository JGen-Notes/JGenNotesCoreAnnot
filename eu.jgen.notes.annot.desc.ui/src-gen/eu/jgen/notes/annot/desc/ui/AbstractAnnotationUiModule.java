...
import eu.jgen.notes.annot.desc.ide.contentassist.antlr.PartialAnnotationContentAssistParser;
import eu.jgen.notes.annot.desc.ide.contentassist.antlr.internal.InternalAnnotationLexer;
import eu.jgen.notes.annot.desc.ui.contentassist.AnnotationProposalProvider;
import eu.jgen.notes.annot.desc.ui.labeling.AnnotationDescriptionLabelProvider;
import eu.jgen.notes.annot.desc.ui.labeling.AnnotationLabelProvider;
import eu.jgen.notes.annot.desc.ui.outline.AnnotationOutlineTreeProvider;
import eu.jgen.notes.annot.desc.ui.quickfix.AnnotationQuickfixProvider;
...
/**
 * Manual modifications go to {@link AnnotationUiModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractAnnotationUiModule extends DefaultXbaseWithAnnotationsUiModule {
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(eu.jgen.notes.annot.desc.parser.antlr.internal.InternalAnnotationLexer.class);
	}
	...
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalAnnotationLexer.class).toProvider(LexerProvider.create(InternalAnnotationLexer.class));
	}
	...
	public Class<? extends ILabelProvider> bindILabelProvider() {
		return AnnotationLabelProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.labeling.LabelProviderFragment2
	public void configureResourceUIServiceLabelProvider(Binder binder) {
		binder.bind(ILabelProvider.class).annotatedWith(ResourceServiceDescriptionLabelProvider.class).to(AnnotationDescriptionLabelProvider.class);
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.outline.OutlineTreeProviderFragment2
	public Class<? extends IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return AnnotationOutlineTreeProvider.class;
	}
	...
	public Class<? extends IssueResolutionProvider> bindIssueResolutionProvider() {
		return AnnotationQuickfixProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.contentAssist.ContentAssistFragment2
	public Class<? extends IContentProposalProvider> bindIContentProposalProvider() {
		return AnnotationProposalProvider.class;
	}
	...
	public Class<? extends IPartialEditingContentAssistParser> bindIPartialEditingContentAssistParser() {
		return PartialAnnotationContentAssistParser.class;
	}
	...
	public void configureCompareViewerTitle(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(UIBindings.COMPARE_VIEWER_TITLE)).toInstance("Annotation Compare");
	}
