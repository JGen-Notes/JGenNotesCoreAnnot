 ...
 */
package eu.jgen.notes.annot.desc.ide.contentassist.antlr;

import com.google.inject.Inject;
import eu.jgen.notes.annot.desc.ide.contentassist.antlr.internal.InternalAnnotationParser;
...
public class AnnotationParser extends AbstractContentAssistParser {
	...
	@Override
	protected InternalAnnotationParser createParser() {
		InternalAnnotationParser result = new InternalAnnotationParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getMetadataAccess().getImportSectionAssignment_3(), "rule__Metadata__ImportSectionAssignment_3");
					put(grammarAccess.getMetadataAccess().getAnnotationsAssignment_4(), "rule__Metadata__AnnotationsAssignment_4");
